...
<head>
    <meta charset="utf-8">
    <title>Vishnu's Crin Job Handler <?php echo (isset($title) ? ' - ' . $title : ''); ?></title>
...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="./">
				Vishnu's CronjobHandler <?php if (isset($_SESSION['cronjobs'], $_SESSION['cronjobs']['run']) && $_SESSION['cronjobs']['run'] == true) echo '(Cronjob running)'; ?>
			</a>
